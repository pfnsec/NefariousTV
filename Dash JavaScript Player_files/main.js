...
app.controller('DashController', function($scope, Sources, Notes, Contributors, PlayerLibraries, ShowcaseLibraries) {
    ...
    function streamSync() {
        ...
        xmlHttp.onreadystatechange = function() { 
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                var serverTrack = jresp['currentTrack'];
                timeStarted = jresp['timeStarted'];
    ...
    setInterval(function() {
        ...
        if(timeStarted != 0.0) {
            ...
            console.error("Time started:" + timeStarted);
            console.error("Server Time:" + serverTime);
            console.error("Now" + Date.now()/1000);
